...
# Request  {"actionType": "courtHearingNotice", "templateType": "attention", "title": "string", "shortText": "string", "fullText": "string" }
# Response {"templateId": "string"}

curl --location 'https://api2t.diia.gov.ua/api/v1/notification/template' \
